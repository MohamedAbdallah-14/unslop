...
Copy-pasteable system and user prompts for humanization work. Five templates: **general humanizer**, **voice-match**, **3-pass edit**, **adversarial paraphrase**, **chatbot persona**. Adjust bracketed `[FIELDS]`; keep the structural bones.

## Template 1 — General Humanizer (one-shot rewrite)

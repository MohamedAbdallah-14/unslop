...
description: >
  ...
  "review this PR", "code review", "/review", "/humanizer-review". Auto-triggers when reviewing PRs.
---
...
`/humanizer-review`, `/review`, "review this PR", "code review", "humanize review", "de-slop this comment", "make this feedback sound human". Auto-trigger when reviewing pull requests.

...
description: >
  ...
  "/humanizer-commit", "/commit", "write a commit", or pastes a draft commit to clean up.
...
`/humanizer-commit`, `/commit`, "write a commit", "commit message", "humanize this commit", "de-slop this commit". Auto-trigger when the user has staged changes and asks for a commit message.

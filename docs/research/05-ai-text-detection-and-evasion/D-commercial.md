...
- **Claimed performance**: GPTZero reports 99.39% overall accuracy, 98.78% recall, and 0.00% FPR for version 4.1b on its own 2026 benchmark (1,000 human + 1,000 AI texts). Its [reanalysis](https://gptzero.me/news/chicago-booth-2026/) of the Jabarian & Imas corpus ([BFI WP 2025-116](https://doi.org/10.3386/w34223)) reports 99.3% recall at 0.1% FPR on clean text. Independent real-world testing (MPG ONE, 2026): 88–95% on raw AI text, dropping to 60–80% on paraphrased or edited content. [1]
- **Underlying technique**: Perplexity + burstiness as baseline, now layered with fine-tuned classifiers, writing-process replay, and a humanizer-awareness layer that maintains a greylist of known bypass methods and patches within days. [1][15][17] See GPTZero's [humanized-text detection note](https://gptzero.me/news/detecting-ai-humanized-text-how-gptzero-stays-ahead/).
...
- **Claimed performance**: "98% accuracy, <1% FP on submissions >300 words." Independent 2025–2026 testing: 92–100% on raw AI text; independent tier tests report 54–85% bypass rates on humanizer-processed text depending on tool and model update (Blommerde, MPG ONE — not Jabarian & Imas / Booth, which did not evaluate Turnitin). Liang et al. found that several detectors misclassified 61.22% of human TOEFL essays in their sample ([arXiv:2304.02819](https://arxiv.org/abs/2304.02819)). [1]
- **Underlying technique**: Proprietary classifier fine-tuned on academic corpora; April 2025 update added Japanese-language detection. 2026 model targets "AI humanizer tool" outputs specifically. October 2025 update softened verdicts and hid 1–19% scores by default due to false-positive incidence. [1]
